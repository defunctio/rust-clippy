...
define_Conf! {
    ...
    /// Lint: LARGE_DATA_PASS_BY_VAL. The minimum size (in bytes) to consider a `Copy` type for passing by ref instead of by value.
    (large_data_size_min_limit, "large_data_size_min_limit", None => Option<u64>),
